...
DROP TABLE IF EXISTS VIDEO_ANSWER_TABLE CASCADE;
...
DROP TABLE IF EXISTS MULTIPLE_CHOICE_QUESTION_CHOICES_TABLE CASCADE;
DROP TABLE IF EXISTS VIDEO_QUESTION_TABLE CASCADE;
