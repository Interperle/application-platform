    ...
    return (
        <>
            ...
            {signUpPossible ? (
                ...
                <div className="py-12 px-8 max-w-xl bg-[#FFFFFF] text-secondary rounded text-center">Die erste Bewerbungsphase ist bereits vorbei und es können keine weiteren Accounts erstellt werden. Wir freuen uns auf euere Bewerbung im nächsten Jahr. Für weitere Informationen bitte besuche unsere Webseite.</div>
            )}
