  ...
  return (
    <main className="grid-cols-1 flex flex-col items-start justify-between p-24 max-w-5xl bg-[#FFFFFF] text-[#153757] space-y-4">
      <div className='flex flex-col items-start justify-between space-y-4'>
        ...
        <p>Wir freuen uns sehr, dass Ihr Euch bei Generation-D bewerben möchtet.</p>
        <p>Aktuell läuft die erste Bewerbungsphase, in welcher es darum geht einige Fragen zu Euerem Start-up/Projekt zu beantworten und zu jedem Teammitglied einen Lebenslauf hochzuladen.</p>
        <strong>Seid Euch bewusst, dass Generation-D keine Bewerbungen akzeptieren kann…</strong>
